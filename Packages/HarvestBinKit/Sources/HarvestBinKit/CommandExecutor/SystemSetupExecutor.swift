...
public enum SystemSetupError: Error, Sendable {
  ...
  public final class DefaultSystemSetupExecutor: SystemSetupExecutor {
    ...
    public func enableSSH() async throws {
      throw SystemSetupError.permissionDenied("systemsetup not available on this platform")
    }
  ...
  /// Stub process runner for non-macOS platforms
  public final class DefaultProcessRunner: ProcessRunner {
    public init() {}

    public func run(executable: String, arguments: [String], requiresElevation: Bool) async throws
      -> ProcessResult {
      throw SystemSetupError.processStartFailed(
        NSError(domain: "UnsupportedPlatform", code: -1, userInfo: nil)
      )
    }
  }
