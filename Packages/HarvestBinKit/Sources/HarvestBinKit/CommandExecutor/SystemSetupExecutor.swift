...
public final class DefaultSystemSetupExecutor: SystemSetupExecutor {
  ...
  public func enableSSH() async throws {
    ...
    guard result.exitCode == 0 else {
      ...
      throw SystemSetupError.commandFailed("enable SSH", exitCode: result.exitCode, output: result.stderr)
    }
  ...
  public func disableSSH() async throws {
    ...
    guard result.exitCode == 0 else {
      ...
      throw SystemSetupError.commandFailed("disable SSH", exitCode: result.exitCode, output: result.stderr)
    }
  ...
  public func getSSHStatus() async throws -> Bool {
    ...
    guard result.exitCode == 0 else {
      ...
      throw SystemSetupError.commandFailed("get SSH status", exitCode: result.exitCode, output: result.stderr)
    }
