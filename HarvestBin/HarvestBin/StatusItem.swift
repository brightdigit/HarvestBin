...
class StatusBarManager {
    ...
    let object : GuestServicesObject
    
    init(object: GuestServicesObject) {
        self.object = object
...
struct StatusBarItemView: View {
    @EnvironmentObject var object : GuestServicesObject
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        statusBarManager = StatusBarManager(object: object)
        object.start()
